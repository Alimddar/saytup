...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    icon: 'Search',
    title: 'Kəşf',
    description: 'Biznesiniz, məqsədləriniz və istifadəçiləriniz haqqında öyrənirik. Aydın brifing daha yaxşı nəticə deməkdir — düzgün sualları əvvəlcədən veririk.',
  },
  {
    id: 'design',
    number: '02',
    icon: 'Pencil',
    title: 'Dizayn',
    description: 'Bir sətir kod yazılmazdan əvvəl bəyənəcəyiniz sxemlər və vizual dizaynlar. Heç bir sürpriz yoxdur.',
  },
  {
    id: 'develop',
    number: '03',
    icon: 'Code',
    title: 'İnkişaf',
    description: 'Müasir texnologiyalarla yazılmış təmiz, test edilmiş kod. Həftəlik irəliləyiş yenilikləri ilə sizi xəbərdar saxlayırıq.',
  },
  {
    id: 'launch',
    number: '04',
    ...
    description: 'Yerləşdirməni biz həll edirik, buraxılışdan sonra yanınızda qalırıq. 1 illik pulsuz dəstək — heç vaxt tək deyilsiniz.',
  },
];
