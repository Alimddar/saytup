...
export const metadata: Metadata = generatePageMetadata({
  title: 'Saytup Haqqında | Azərbaycanda Veb İnkişaf Studiyası',
  description: 'Saytup.digital haqqında — Azərbaycanda qurulan veb inkişaf studiyası. Kiçik bizneslərin güclü onlayn mövcudluq yaratmasına kömək edirik. Komandamız, dəyərlərimiz.',
  keywords: [
    'saytup haqqında', 'Azərbaycan veb studiyası', 'veb inkişaf komandası',
    'Azərbaycanda veb inkişaf şirkəti', 'Azərbaycan veb dizayn agentliyi',
    'Azərbaycan',
  ],
  path: '/about',
});
              ...
              <ScrollReveal key={member.name} delay={index * 0.1}>
                <div className="text-center">
                  <div className="w-24 h-24 rounded-full overflow-hidden mx-auto mb-4 ring-4 ring-brand-blue-light">
                    <Image
                      src={member.image}
                      alt={`${member.name} — ${member.role}, Saytup.digital komandası`}
                      width={96}
                      height={96}
